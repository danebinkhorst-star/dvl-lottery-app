...
Gebruik voor `SHOPIFY_WEBHOOK_SECRET` dezelfde secret als de Shopify app secret. Gebruik voor de andere secrets unieke lange random waarden; hergebruik ze niet.
