...
export const widgetDefinitions = [
  ...
  },
  {
    ...
    defaults: {
      kicker: "Winnaars",
      heading: "Winnaars komen hier live.",
      body: "Voorbeeld met realistische beelden tot de eerste echte winnaars gepubliceerd zijn.",
      emptyLabel: "Nog geen winnaars gepubliceerd",
      emptyValue: "Live",
      winnerOneName: "Voorbeeldwinnaar",
      winnerOnePrize: "Voorbeeld BBQ Box",
      winnerOneStory: "Voorbeeldkaart tot de eerste echte winnaar is gepubliceerd.",
      winnerOneImageUrl: "https://i.pravatar.cc/160?img=12",
      winnerTwoName: "Voorbeeldwinnaar",
      winnerTwoPrize: "Voorbeeld vleestegoed",
      winnerTwoStory: "Voorbeeldkaart tot de winnaarshistorie gevuld is met echte data.",
      winnerTwoImageUrl: "https://i.pravatar.cc/160?img=47",
      winnerThreeName: "Voorbeeldwinnaar",
      winnerThreePrize: "Voorbeeld kamado pakket",
      winnerThreeStory: "Voorbeeldkaart voor de layout, niet een bevestigde trekking.",
      winnerThreeImageUrl: "https://i.pravatar.cc/160?img=32",
      winnerFourName: "Voorbeeldwinnaar",
      winnerFourPrize: "Voorbeeld dry-aged pakket",
      winnerFourStory: "Voorbeeldkaart tot admin echte winnaar content toevoegt.",
