...
export const widgetDefinitions = [
  ...
  },
  {
    ...
    defaults: {
      ...
      emptyValue: "Live",
      winnerOneName: "Mark uit Breda",
      winnerOnePrize: "BBQ Box",
      winnerOneStory: "Won na zijn weekendbestelling en deelde de box met zijn vaste BBQ-groep.",
      winnerOneImageUrl: "/assets/placeholders/winner-bbq.svg",
      winnerTwoName: "Sanne uit Rotterdam",
      winnerTwoPrize: "250 euro vleestegoed",
      winnerTwoStory: "Haar bestelling boven EUR 70 koppelde automatisch een lot aan de trekking.",
      winnerTwoImageUrl: "/assets/placeholders/winner-credit.svg",
      winnerThreeName: "Youssef uit Utrecht",
      winnerThreePrize: "Kamado pakket",
      winnerThreeStory: "Volgde zijn lot in Mijn MFF en won de maandprijs voor buitenkoks.",
      winnerThreeImageUrl: "/assets/placeholders/winner-kamado.svg",
      winnerFourName: "Niels uit Haarlem",
      winnerFourPrize: "Dry-aged pakket",
      winnerFourStory: "Pakte met zijn tweede order direct een lot voor de live winactie.",
      winnerFourImageUrl: "/assets/placeholders/winner-aged.svg"
    }
  },
  {
    key: "customer",
